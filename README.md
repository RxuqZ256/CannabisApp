...
Zonen befindet und blendet einen entsprechenden Hinweis ein. Die Karte wird
erst initialisiert, wenn der Bereich geöffnet wird, damit sie korrekt angezeigt
wird.
